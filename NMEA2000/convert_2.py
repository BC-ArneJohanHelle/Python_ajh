...
#			frame = decodeBlueCtrlNativeCan(TextString)
			...
			if frame.payload is not None:
				...
				if frame.pgn_id == 129025 and frame.isoname == 13868994483158255951 :
					...
					pass
				if frame.pgn_id == 129026 and frame.isoname == 13868994483158255951 :
				...
				if frame.pgn_id == 60928:
					store.set(frame.source_id, _u_le(frame.payload, 0, 8))
